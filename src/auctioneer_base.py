...
import random
import inflect
from .bidder_base import Bidder, GeminiChat
from .human_bidder import HumanBidder
from .item_base import Item
from .prompt_base import PARSE_BID_INSTRUCTION

# Small, cheap Gemini model used just for parsing a bid amount out of free text.
_BID_PARSE_MODEL = 'gemini-2.5-flash'
...
class Auctioneer(BaseModel):
    ...
    def parse_bid(self, text: str):
        ...
        llm = GeminiChat(model_name=_BID_PARSE_MODEL, temperature=0)
