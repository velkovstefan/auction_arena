...
class Item():
    def __init__(self, id: int, name: str, price: int, desc: str, true_value: int, category: str, condition: float, rarity: float, brand_tier: int):
        self.id = id
        self.name = name
        self.price = price
        self.desc = desc
